...
const PostPreview: FC<{
  ...
  <div className="block w-full transform rounded-xl bg-emerald-50/50 shadow transition duration-200 hover:scale-[1.02] hover:bg-emerald-50/20 hover:shadow-lg">
